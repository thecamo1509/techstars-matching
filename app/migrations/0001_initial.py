    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'startup'), (2, 'mentor'), (3, 'staff')], default=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentorNotes', models.CharField(blank=True, max_length=200)),
                ('startupNotes', models.CharField(blank=True, max_length=200)),
